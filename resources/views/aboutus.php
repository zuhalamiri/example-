...
<!-- Mirrored from preview.keenthemes.com/metronic/demo1/rtl/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Mar 2021 12:30:58 GMT -->
...
<head>
		...
		<link href="{{asset('assets/plugins/custom/fullcalendar/fullcalendar.bundle.rtl62fd.css?v=7.2.3')}}" rel="stylesheet" type="text/css" />
		<!--end::Page Vendors Styles-->
		<!--begin::Global Theme Styles(used by all pages)-->
		<link href= " {{asset('assets/plugins/global/plugins.bundle.rtl62fd.css?v=7.2.3')}}" rel="stylesheet" type="text/css" />
		<link href ="{{ asset('assets/plugins/custom/prismjs/prismjs.bundle.rtl62fd.css?v=7.2.3') }}"  rel="stylesheet" type="text/css" />
		<link href ="{{ asset('assets/css/style.bundle.rtl62fd.css?v=7.2.3') }}"  rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<link href ="{{ asset('assets/css/themes/layout/header/base/light.rtl62fd.css?v=7.2.3') }}"  rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/css/themes/layout/header/menu/light.rtl62fd.css?v=7.2.3') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/css/themes/layout/brand/dark.rtl62fd.css?v=7.2.3') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/css/themes/layout/aside/dark.rtl62fd.css?v=7.2.3') }}" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="{{asset('resource../assets/media/logos/tveta-logo-new.png')}}" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
		...
		<script src="{{('assets/plugins/global/plugins.bundle62fd.js?v=7.2.3')}}"></script>
		<script src="{{('assets/plugins/custom/prismjs/prismjs.bundle62fd.js?v=7.2.3')}}"></script>
		<script src="{{('assets/js/scripts.bundle62fd.js?v=7.2.3')}}"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Vendors(used by this page)-->
		<script src="{{('assets/plugins/custom/fullcalendar/fullcalendar.bundle62fd.js?v=7.2.3')}}"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="{{('assets/js/pages/widgets62fd.js?v=7.2.3')}}"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/metronic/demo1/rtl/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Mar 2021 12:33:07 GMT -->
</html>